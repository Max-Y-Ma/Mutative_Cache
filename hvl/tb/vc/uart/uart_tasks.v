...
`define TICKS_PER_SECOND 64'd1_000_000_000_000
...
begin 
	...
	case (baud)
		`BAUD_115200: bit_time = `TICKS_PER_SECOND/(115200 + 1152*baud_error_factor);
//	        `BAUD_115200: bit_time = 40000000000/(115200 + 1152*baud_error_factor);
		`BAUD_38400:  bit_time = `TICKS_PER_SECOND/(38400 + 384*baud_error_factor);
		`BAUD_28800:  bit_time = `TICKS_PER_SECOND/(28800 + 288*baud_error_factor);
		`BAUD_19200:  bit_time = `TICKS_PER_SECOND/(19200 + 192*baud_error_factor);
		`BAUD_9600:   bit_time = `TICKS_PER_SECOND/(9600 + 96*baud_error_factor);
		`BAUD_4800:   bit_time = `TICKS_PER_SECOND/(4800 + 48*baud_error_factor);
		`BAUD_2400:   bit_time = `TICKS_PER_SECOND/(2400 + 24*baud_error_factor);
		`BAUD_1200:   bit_time = `TICKS_PER_SECOND/(1200 + 12*baud_error_factor);
	endcase   
...
begin 
	...
	// calculate bit time from input baud rate - this assumes a simulation resolution of 1ns 
	case (baud)
		`BAUD_115200: bit_time = `TICKS_PER_SECOND/115200;
		`BAUD_38400:  bit_time = `TICKS_PER_SECOND/38400;
		`BAUD_28800:  bit_time = `TICKS_PER_SECOND/28800;
		`BAUD_19200:  bit_time = `TICKS_PER_SECOND/19200;
		`BAUD_9600:   bit_time = `TICKS_PER_SECOND/9600;
		`BAUD_4800:   bit_time = `TICKS_PER_SECOND/4800;
		`BAUD_2400:   bit_time = `TICKS_PER_SECOND/2400;
		`BAUD_1200:   bit_time = `TICKS_PER_SECOND/1200;
	endcase   
